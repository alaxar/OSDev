...
} __attribute__((packed)) xhci_CapRegs_t;
...
} __attribute__((packed)) xhci_PortRegs_t;
...
} __attribute__((packed)) xhci_OpRegs_t;

typedef struct
{
    volatile uint32_t dword;
} __attribute__((packed)) xhci_DoorbellRegs_t;
...
typedef struct
{
    ...
    uint32_t reserved2;
} __attribute__((packed)) xhci_eventRingSegmentTableEntry_t;
...
} __attribute__((packed)) interrupterRegisterSet_t;
...
} __attribute__((packed)) xhci_RuntimeRegs_t;
...
} __attribute__((packed)) xhci_DeviceContextArray_t;
...
} __attribute__((packed)) xhci_slotContext_t;
...
typedef struct
{
    ...
    uint8_t reserved2;
} __attribute__((packed)) xhci_InputControlContext_t;

typedef struct
{
    xhci_InputControlContext_t ICC;
    xhci_DeviceContext_t       DC;
} __attribute__((packed)) xhci_InputContext_t;
...
typedef struct
{
    ...
    uint8_t  SlotID;
} __attribute__((packed)) xhci_cmd_DeviceTRB_t;
...
typedef struct
{
    ...
    uint8_t  SlotID;
} __attribute__((packed)) xhci_cmd_ResetEndpointTRB_t;
...
typedef struct
{
    ...
    uint32_t SP                :  1;
    uint8_t  SlotID;
} __attribute__((packed)) xhci_cmd_StopEndpointTRB_t;
...
} __attribute__((packed)) xhci_TR_DequeuePointerTRB_t;
...
} __attribute__((packed)) xhci_LinkTRB_t;
...
} __attribute__((packed)) xhci_eventTRB_t; // 6.4.2 Event TRBs
...
} __attribute__((packed)) xhci_xfer_NormalTRB_t;
...
} __attribute__((packed)) xhci_xfer_SetupStageTRB_t;
...
} __attribute__((packed)) xhci_xfer_DataStageTRB_t;
...
} __attribute__((packed)) xhci_xfer_StatusStageTRB_t;
